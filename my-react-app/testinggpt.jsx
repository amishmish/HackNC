...
async function getProjectMaterials(userInput) { //asks GPT for materials for project input
    const response = await llm.generate(`List the materials and quantity of each needed to build a ${userInput} using products from Lowe's and place each item on a new line in the format "material == quantity".`);
