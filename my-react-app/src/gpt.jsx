...
<<<<<<< HEAD:my-react-app/src/gpt.js
    const response = await llm.generate(`List the materials and quantity of each needed to build a ${projectDescription} using products from ${link} and place each item on a new line in the format "material : quantity".`);
...
=======
    ...
    return response.split('\n');
>>>>>>> 63d1117d73f02e996c8249e4a03b451b88a05490:my-react-app/src/gpt.jsx
}
